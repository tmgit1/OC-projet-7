...
image_path = "dashboard_eda_image_samples.png"
...
breed_dirs = [d for d in os.listdir("Images") if os.path.isdir(os.path.join("Images", d))]
...
image_files = [f for f in os.listdir(os.path.join("Images", selected_breed)) if f.endswith(".jpg")]

# Sélection d'une image aléatoire dans la liste
random_image_file = random.choice(image_files)

image_path = os.path.join("Images", selected_breed, random_image_file)
image = Image.open(image_path)
